...
/*   Updated: 2017/11/24 20:08:15 by saxiao           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			find_fit(tetri_map *map, tetri_list *list);
int			empty_col(char **s);
void  		mv_left_top(char **s);
int			check_fill(tetri_map *map, tetri_list *list, int x, int y);
void		only_dot_hash(char *s, int len);
void		valid_tetri(char *s);
tetri_list	*ft_readfile(char const *file_name, int nb_tetri);
void		ft_exit(char const *s);
